...
function get_customer($customer_id) {
    global $db;
    $query = 'SELECT * FROM khachhang WHERE idkhachhang = :customer_id';
    $statement = $db->prepare($query);
...
function customer_change_shipping_id($customer_id, $address_id) {
    global $db;
    $query = 'UPDATE khachhang SET iddiachigiaohang = :address_id
...
function customer_change_billing_id($customer_id, $address_id) {
    global $db;
    $query = 'UPDATE khachhang SET iddiachithanhtoan = :address_id
              WHERE idkhachhang = :customer_id';
    $statement = $db->prepare($query);
    $statement->bindValue(':address_id', $address_id);
    $statement->bindValue(':customer_id', $customer_id);
...
function add_customer($email, $first_name, $last_name,
    ...
    $query = '
        INSERT INTO khachhang (email, password, firstName, lastName)
