...
function cart_add_item($product_id, $quantity) {
    ...
    $_SESSION['last_category_id'] = $product['idloaisanpham'];
    $_SESSION['last_category_name'] = $product['tenloaisanpham'];
}
...
function cart_get_items() {
    ...
    foreach ($_SESSION['cart'] as $product_id => $quantity ) {
        ...
        $items[$product_id]['name'] = $product['tensanpham'];
        $items[$product_id]['description'] = $product['motasanpham'];
